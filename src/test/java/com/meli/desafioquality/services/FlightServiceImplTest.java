...
import com.meli.desafioquality.repositories.FlightRepositoryImpl;
...
public class FlightServiceImplTest {
    ...
    @Test
    public void getFlightsTestAll() throws IOException, ParseException, ApiException {
        Map<String, String> params = new HashMap<>();
        FlightDataDTO dataFlight = objectMapper.readValue(new File(ValidateConfigurationTest.PATH_FLIGHT.getProperty()),
                new TypeReference<>() {
                });
        FlightDataDTO dataFlightMock = flightService.getFlights(params);
        Assertions.assertEquals(dataFlightMock, dataFlight);
    }

    @Test
    public void createFlightReservationTest() throws IOException, ParseException, ApiException {
        FlightDataDTO dataFlight = objectMapper.readValue(new File(ValidateConfigurationTest.PATH_FLIGHT.getProperty()),
                new TypeReference<>() {
                });
